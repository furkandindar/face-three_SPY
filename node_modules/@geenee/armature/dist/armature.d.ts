...
declare type ImageInput = ImageData | ImageBuffer | HTMLCanvasElement;
/** Image buffer */
 ...
 *
 * Helper class implementing grabbing of images into
 * internal storage with fast rescaling if required.
 * Used by [[VideoCapture]] to grab video streams and
 * [[Engine]] to resize images for faster processing.
 */
declare class CaptureContext {
    /** Size of video */
    size: Size;
     ...
     *
     * @returns Grabbed image buffer on success, undefined otherwise
     */
...
declare type VideoSetupParams = VideoParams | MediaStream | MediaStreamConstraints;
 ...
 * Internally VideoCapture utilizes [[CaptureContext]] as storages.
 */
declare class VideoCapture extends EventEmitterT<CaptureEvents> {
    protected params?: VideoSetupParams | undefined;
    /** Video element */
    protected videoRef: HTMLVideoElement;
    /** Context of original stream */
    protected captureCtx: CaptureContext;
    /** Timestamp of the last captured frame */
    captureTime: number;
    /**
     * Constructor
     *
     * @param params - Requested video parameters
     */
    constructor(params?: VideoSetupParams | undefined);
    /**
     * Setup video capture
     *
     ...
     */
    setup: (params?: VideoSetupParams | undefined) => Promise<boolean>;
    ...
    */
     ...
     *
     * VideoCapture grabs the next image from the video source
     * (camera) and stores it in embedded [[CaptureContext]].
     *
     * @returns True if next frame has been available and grabbed
     */
    capture: () => boolean;
    /**
     * Video capture context
     *
     * Returns context capturing the video. This context
     * can further be used to retrieve canvas with video
     * frame or read image buffer into ImageData object
     *
     * @returns Video capture context
     */
...
interface ProcParams {
    /** Root path to computational resources */
    root?: string;
    /** Cache computational resource */
    cache?: boolean;
}
...
declare class Engine<ResultT, ParamsT extends ProcParams, ProcessorT extends Processor<ResultT, ParamsT>> extends EventEmitterT<EngineEvents> {
    ...
    /** Context to resize frames */
    protected resizeContext?: CaptureContext;
     ...
     * @typeParam ParamsT - Type of processor parameters
     */
    constructor(Processor: new () => ProcessorT, engineParams?: EngineParams | undefined);
    /**
     ...
     * @returns Status of initialization
     */
    init: (procParams?: ParamsT | undefined) => Promise<boolean>;
    /**
     ...
     * @returns Status of initialization
     */
    setup: (videoParams?: VideoSetupParams | undefined) => Promise<boolean>;
    /**
     * Start pipeline.
     *
    ...
    /** Setup video capture */
    protected setupVideo(videoParams?: VideoSetupParams): Promise<boolean>;
    /** Setup video size */
 ...
 * @typeParam ParamsT - Type of processor parameters
 */
declare class AsyncEngine<ResultT, ParamsT, ProcessorT extends Processor<ResultT, ParamsT>> extends Engine<ResultT, ParamsT, ProcessorT> {
...
export { AsyncEngine, CanvasParams, CanvasRenderer, CaptureContext, Engine, EngineParams, EventEmitterT, ImageBuffer, ImageInput, ProcParams, Processor, Recorder, Renderer, ResponsiveCanvas, ScenePlugin, SceneRenderer, Size, Snapshoter, Streamer, VideoCapture, VideoParams, VideoPlugin, VideoRenderer, VideoSetupParams };
