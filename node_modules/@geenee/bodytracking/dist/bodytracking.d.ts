...
declare class PoseTracker {
    ...
    init(root?: string, cache?: boolean, backend?: "webgl" | "cpu"): Promise<void>;
    reset(): void;
    prepare(): Promise<void>;
    dispose(): void;
}
...
declare class FaceTracker {
    ...
    protected trackFrames: number;
    readonly meshSize = 468;
